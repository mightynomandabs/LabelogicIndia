...
const EnhancedNavbar = () => {
  ...
  return (
    <nav className={`sticky top-0 z-50 py-3 px-4 md:px-6 lg:px-8 w-full transition-all duration-300 ${
      isScrolled 
        ? 'bg-brand-yellow/95 backdrop-blur-md shadow-md border-b border-brand-black/10' 
        : 'bg-brand-yellow/95 backdrop-blur-sm shadow-md border-b border-brand-black/10'
    }`}>
